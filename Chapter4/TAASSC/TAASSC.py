...
def BTR_XML(xml_files,outname,index_list,cats): #for processing TMLE xml texts
	...
	tt_list = open("./TAASSC/lists_BTR/text_type_map_2020-5-24.txt").read().split("\n")
	tt_dict = {}
	for x in tt_list:
		line = x.split("\t")
...
def BTR_tt_find(xml_files): #for processing TMLE xml texts
	tt_list = open("./TAASSC/lists_BTR/text_type_map.txt").read().split("\n")
	tt_dict = {}
	for x in tt_list:
		line = x.split("\t")
...
semantic_noun = open("./TAASSC/lists_BTR/semantic_class_noun.txt").read().split("\n")
semantic_verb = open("./TAASSC/lists_BTR/semantic_class_verb.txt").read().split("\n")
semantic_adj = open("./TAASSC/lists_BTR/semantic_class_adj.txt").read().split("\n")
semantic_adv = open("./TAASSC/lists_BTR/semantic_class_adverb_5-25-20.txt").read().split("\n")
nominal_stop = open("./TAASSC/lists_BTR/nom_stop_list_edited.txt").read().split("\n")
...
for x in "main_tag spec_tag1 spec_tag2 spec_tag3 spec_tag4 spec_tag5 spec_tag6 semantic_tag1 semantic_tag2".split(" "):
	cats[x] = None
index_list = open("./TAASSC/lists_BTR/btr_index_list_5-26-20.txt").read().split("\n")
...
def data_analysis(text):
	return BTR_Analysis(text,index_list,cats)
